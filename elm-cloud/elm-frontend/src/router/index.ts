        ...
        children: [
          {
            ...
            name: "UserProfile",
            component: () =>
              import("../views/customer/Profile/UserProfile.vue"),
            meta: { title: "我的信息" },
          },
          {
            path: "addresses",
            ...
            component: () =>
              import("../views/customer/Profile/AddressManagement.vue"),
            meta: { title: "地址管理" },
          },
          {
            path: "orders",
            name: "OrderHistory",
            component: () =>
              import("../views/customer/Profile/OrderHistory.vue"),
            meta: { title: "我的订单" },
          },
          {
            path: "orders/:id",
            name: "OrderDetail",
            component: () =>
              import("../views/customer/Profile/OrderDetail.vue"),
            meta: { title: "订单详情" },
          },
          {
            path: "review/:orderId",
          ...
          },
          {
            ...
            component: () =>
              import("../views/customer/Profile/ApplyAsMerchant.vue"),
            meta: { title: "成为商家" },
          },
          {
            path: "wallet",
  ...
  // Merchant routes
  {
    ...
    children: [
      ...
      },
      {
        path: "points",
        name: "MerchantPoints",
        component: () => import("../views/merchant/Points.vue"),
        meta: { title: "我的积分" },
      },
      {
        path: "applications",
        name: "MyApplications",
        component: () => import("../views/merchant/MyApplications.vue"),
        meta: { title: "我的申请" },
      },
      {
        path: "user-profile",
...
const mobileRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    },
    {
      ...
      component: () =>
        import("../views/mobile/customer/MobileRestaurantDetail.vue"),
      meta: { title: "餐厅详情" },
    },
    {
      path: "orders",
    ...
    },
    {
      ...
      component: () =>
        import("../views/mobile/customer/Profile/AddressManagement.vue"),
    ...
    },
    {
      ...
      component: () =>
        import("../views/mobile/customer/Profile/ApplyAsMerchant.vue"),
...
const mobileMerchantRoutes: RouteRecordRaw = {
  ...
  children: [
    {
      path: "dashboard",
      name: "MobileMerchantDashboard",
      component: () => import("../views/mobile/merchant/MerchantDashboard.vue"),
      meta: { title: "商家仪表盘" },
    },
    {
      path: "menu",
      name: "MobileMenuManagement",
      component: () =>
        import("../views/mobile/merchant/MerchantMenuManagement.vue"),
      meta: { title: "菜单管理" },
    },
    {
      path: "profile",
      name: "MobileBusinessProfile",
      component: () =>
        import("../views/mobile/merchant/BusinessInfoManagement.vue"),
      meta: { title: "商家信息管理" },
    },
    {
      path: "orders",
      name: "MobileMerchantOrderHistory",
      component: () =>
        import("../views/mobile/merchant/MerchantOrderHistory.vue"),
      meta: { title: "历史订单" },
    },
    {
      path: "applications",
      name: "MobileMyApplications",
      component: () => import("../views/mobile/merchant/MyApplications.vue"),
      meta: { title: "我的申请" },
    },
    {
      path: "user-profile",
      name: "MobileMerchantUserProfile",
      component: () => import("../components/UserProfile.vue"),
      meta: { title: "我的资料" },
    },
  ],
...
const mobileAdminRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import("../views/mobile/admin/UserManagement.vue"),
      meta: { title: "用户管理" },
    },
    {
      path: "businesses",
      name: "MobileMerchantManagement",
      component: () => import("../views/mobile/admin/MerchantManagement.vue"),
      meta: { title: "商家管理" },
    },
    {
      path: "shops",
      name: "MobileShopManagement",
      component: () => import("../views/mobile/admin/ShopManagement.vue"),
      meta: { title: "店铺管理" },
    },
    {
      path: "vouchers",
      name: "MobileVoucherManagement",
      component: () => import("../views/mobile/admin/VoucherManagement.vue"),
      meta: { title: "优惠券管理" },
    },
    {
      path: "user-profile",

...
import cn.edu.tju.wallet.utils.TOPUPPublicVoucherSelectorImpl;
...
public class TransactionServiceImpl implements TransactionService {
  ...
  public TransactionVO createTransaction(
    ...
    // For TOP_UP and WITHDRAW, mark as finished immediately since there's no external payment
    // platform
    ...
    if (type.equals(TransactionType.TOP_UP)) {
      PublicVoucherVO publicVoucherVO =
          publicVoucherService.chooseBestPublicVoucherForTransaction(
              new TransactionVO(transaction), new TOPUPPublicVoucherSelectorImpl());

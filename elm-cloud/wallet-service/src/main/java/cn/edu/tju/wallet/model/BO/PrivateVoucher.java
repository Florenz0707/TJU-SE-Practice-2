package cn.edu.tju.wallet.model.BO;
...
@Entity
@Table(
    name = "private_voucher",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"wallet_id", "public_voucher_id"})})
public class PrivateVoucher extends BaseEntity {
  ...
  public static PrivateVoucher createPrivateVoucher(
      Wallet wallet, PublicVoucherVO publicVoucherVO) {

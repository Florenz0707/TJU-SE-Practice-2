...
public class FoodController {
  ...
  public HttpResult<List<Food>> getAllFoods(
      @Parameter(description = "商家ID") @RequestParam(name = "business", required = false)
          Long businessId,
      @Parameter(description = "订单ID") @RequestParam(name = "order", required = false)
          Long orderId) {
    if ((businessId == null && orderId == null) || (businessId != null && orderId != null))
      return HttpResult.failure(
          ResultCodeEnum.SERVER_ERROR, "HAVE TO PROVIDE ONE AND ONLY ONE ARG");
  ...
  public HttpResult<Food> substituteFood(
    ...
    if (oldFood == null) return HttpResult.failure(ResultCodeEnum.NOT_FOUND, "Food NOT FOUND");
  ...
  public HttpResult<Food> updateFood(
    ...
    if (newFood == null) return HttpResult.failure(ResultCodeEnum.NOT_FOUND, "Food CANT BE NULL");
    ...
    if (isAdmin || (isBusiness && me.getId().equals(food.getBusiness().getBusinessOwnerId()))) {
      ...
      if (newFood.getFoodImg() == null) newFood.setFoodImg(food.getFoodImg());
      if (newFood.getRemarks() == null) newFood.setRemarks(food.getRemarks());

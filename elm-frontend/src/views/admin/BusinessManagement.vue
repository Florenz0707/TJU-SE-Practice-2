      ...
      <template #actions="{ row }">
        <div v-if="row.status === 'Pending'">
          <el-button
            size="small"
            type="success"
            @click="handleApprove(row as Business)"
            >Approve</el-button
          >
          <el-button
            size="small"
            type="danger"
            @click="handleReject(row as Business)"
            >Reject</el-button
          >
        </div>
        <el-button v-else size="small" @click="handleEdit(row as Business)"
          >View/Edit</el-button
        >
      </template>
    </DataTable>

<template>
  <div class="mobile-address-management-page">
    <el-page-header content="地址管理" @back="goBack"></el-page-header>
    ...
    <div class="address-list">
      ...
      >
        ...
        <div class="address-actions">
          <el-button size="small" @click="openAddressDialog(address)"
            >编辑</el-button
          >
          <el-popconfirm
            title="确定删除吗？"
    ...
    <el-dialog
      ...
      width="90%"
    >
      <el-form ref="formRef" :model="addressForm" label-position="top">
        <el-form-item
          label="联系人"
          prop="contactName"
...
<style scoped>
.mobile-address-management-page {
  padding: 1rem;
}
.el-page-header {

      ...
      <div v-for="order in orders" :key="order.id" class="order-card">
        <div class="card-header">
          ...
          <span
            class="status"
            :style="{
              color: getOrderStatusInfo(order.orderState as OrderStatus).type,
            }"
            >{{
        ...
        <div class="card-footer">
          <el-button size="small" @click="viewOrderDetails(order.id!)"
            >查看详情</el-button
          >
          <el-button
            v-if="order.orderState === OrderStatusEnum.COMPLETE"
            size="small"
            type="primary"

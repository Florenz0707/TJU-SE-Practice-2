  ...
  <div class="vouchers-view">
    <el-tabs type="border-card">
          ...
          >
            <div class="voucher-content">
              ...
              <div class="voucher-right">
                ...
                <div class="date">
                  有效期至: {{ new Date(v.expiryDate).toLocaleDateString() }}
                </div>
                <div class="status">
      ...
      <el-tab-pane label="领券中心">
        <div class="voucher-list">
          <el-empty
            v-if="publicVouchers.length === 0"
            description="暂无优惠券可领"
          />
          <el-card
            v-for="v in publicVouchers"
            :key="v.id"
            class="voucher-card claimable"
          >
            <div class="voucher-content">
              <div class="voucher-left">
                <div class="amount">
...
async function handleClaim(id: number) {
  try {
    ...
    ElMessage.error("领取失败: " + (e as Error).message);
  }
}
